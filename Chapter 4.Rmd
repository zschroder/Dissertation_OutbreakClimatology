...
```{r}
All_Tornadoes <- st_set_crs(All_Tornadoes, 26919)
st_crs(All_Tornadoes)
All_Tornadoes <- st_transform(All_Tornadoes, 4326)
st_crs(All_Tornadoes)
...
```{r}
max(BigDays1994_2020$nT)

mean(BigDays1994_2020$nT)
```

```{r}
sum(BigDays1994_2020$nT <= 22) / dim(BigDays1994_2020)[1]
```
